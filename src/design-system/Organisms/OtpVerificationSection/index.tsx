...
const OtpVerificationSection: React.FC<InputFieldComponentProps> = () => {
  ...
  const otpAttemptLimit = 3; // Set the OTP attempt limit
  ...
  const handleReSendOtp = useCallback(() => {
    if (resendCount < otpAttemptLimit) {
      sendOtp(otpDetails);
  ...
  }, [sendOtp, otpDetails, resendCount, otpAttemptLimit]);
