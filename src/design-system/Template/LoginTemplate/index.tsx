...
const LoginTemplate: React.FC<templateProps> = ({ isVerification }) => {
  ...
  return (
      ...
      <Box className={styles.loginPage}>
        <Grid container>
          ...
          <Grid item lg={5} md={6} xs={12} sm={12} className={styles.formCol}>
            <Box
            ...
            >
              {!isVerification ? <LoginSection /> : <OtpVerificationSection />}
            </Box>
          </Grid>
        </Grid>
      </Box>
